		...
		<nav class="navbar navbar-inverse">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				...
				<ul class="nav navbar-nav navbar-right">
					<li><a href="employeeconfirm.php"><span class="glyphicon glyphicon-user"></span>My account</a></li>
					<li><a href="#"><span class="glyphicon glyphicon-user"></span>My cart</a></li>
					<li><a href="employeeindex.php"><span class="glyphicon glyphicon-user"></span>Logout</a></li>
					</ul>
				</div>
			</div>
		</nav>
